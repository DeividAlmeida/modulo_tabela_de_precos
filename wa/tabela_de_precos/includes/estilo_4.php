...
<style type="text/css">
 ...
 <?php if($categoria['efeito_hover'] === 'Não'){echo "/*";}?>.member-align-center:hover {-webkit-box-shadow: -600px 0px 0 <?php echo $categoria['cor_icone']; ?> inset !important;-moz-box-shadow: -600px 0px 0 <?php echo $categoria['cor_icone']; ?> inset !important;box-shadow: -600px 0px 0 <?php echo $categoria['cor_icone']; ?> inset !important;}
  button :hover {background-color: <?php echo $categoria['cor_hover_icone']; ?> !important; color: <?php echo $categoria['cor_hover_txt']; ?>;border-radius: 3px;}
...
.member-icon:hover {transition-delay: 2s; background-color: <?php echo $categoria['cor_icone']; ?> !important;}
  .member-photo:hover {background-color: <?php echo $categoria['cor_borda']; ?> !important }
*/</style>
    ...
    <div class="row">
      ...
      <div class="col-sm-<?php echo (12/$categoria['colunas']); ?> "  style="<?php if ($i['featured'] === 'margin-top: 25%'){echo "margin-top: -3%"; }?>;padding-bottom: 40px;">
        ...
        transition-duration: 0.5s;min-height: 300px;box-shadow: 0 0 1px #ccc;box-shadow: 0px 0 0 #fff inset;">
                                                    ...
                                                    <!--  HEAD -->
            <center>
                <div class="member-photo" style="background-color:<?php echo $categoria['cor_bg_botao']; ?>;-webkit-box-shadow: 0 2px 7px 0px rgba(0, 0, 0, 0.1);box-shadow: 0 2px 7px 0px rgba(0, 0, 0, 0.1);">
                    <div style="min-height: 130px;"><div class="badge" style="position: absolute; top: 0;left: 50%;padding: 4px 8px;background-color:<?php echo $i['cor_tg_ft'];?>;color: <?php echo $i['cor_txt_tg_ft'];?>;border-radius: 0 0 5px 5px;font-size: 11px;-webkit-transform: translateX(-50%);transform: translateX(-50%);<?php if ($i['featured'] === 'margin-top: 25%'){}else{echo "display: none"; }?>">       <?php echo $i['tg_txt']; ?>
                    </div><br>
                    <h1 class="member-name" style=" color: <?php if ($i['featured'] === 'margin-top: 25%'){ echo $i['cor_txt_ft'];}else{echo $categoria['cor_titulo']; }?>; font-size: 24px;letter-spacing: 1px; position: relative;  "><?php echo $i['titulo']; ?>           
                    </h1>
                    <span class="member-role" style="color: <?php if ($i['featured'] === 'margin-top: 25%'){ echo $i['cor_txt_ft'];}else{echo $categoria['cor_subtitulo']; }?>; margin-top: 1%;display: block;font-size: 22px; line-height: normal;font-weight: 600;"><?php echo $i['subtitulo']; ?></span><span class="duration" style="color: <?php if ($i['featured'] === 'margin-top: 25%'){ echo $i['cor_txt_ft'];}else{echo $categoria['cor_subtitulo']; }?>;    display: block;font-size: 11px;margin-top: 0px;color: "><?php echo $i['auxiliar'];?></span>
                        </div>
                </div>
            </center>
                                                        <!-- BODY -->
            <div  class="member-info" style="background-color: transparent; min-height: 100px; height: auto;">
              <?php foreach($social as $s): ?> 
                <ul target="_blank" href="" class="member-icon" style="text-decoration: none; position: relative; right: 5%; color: <?php if ($i['featured'] === 'margin-top: 25%'){echo $i['cor_txt_ft']; }else{echo $categoria['cor_bg'];}?>; font-size: 12px; padding: 0; text-align: left; margin-top: 8%; margin-left: 10%; ">
                     <li class="zxc" style=" width: 80%;  list-style-type: none; display: inline-block;  overflow-wrap: break-word; background-color: transparent; "> <?php echo $s['link']; ?> </li> 
                            <li id="zxc" style=" position: absolute; right: 0%; display: inline-block; white-space: nowrap;border-left: 1px solid <?php if ($i['featured'] === 'margin-top: 25%'){echo $i['cor_txt_ft']; }else{echo $categoria['cor_bg'];}?>;padding-left: 9px;"  class="<?php echo $s['icon_social']; ?>"></li>  
                </ul>
                    <?php endforeach; ?>
            </div>
      ...
      ">
        <button  type="button"   class="button.list-group-item" style="margin: 10%;background-color: <?php echo $categoria['cor_hover_botao']; ?>; padding: 0px; border-color: <?php echo $categoria['cor_hover_botao']; ?>; border: 1px solid <?php echo $categoria['cor_hover_icone']; ?>;border-radius: 3px;" >
