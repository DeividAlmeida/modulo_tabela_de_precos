...
<style type="text/css">
  ...
  <?php if($categoria['efeito_hover'] === 'Não')
  {echo "/*";}?>
.member-align-center:hover {-webkit-box-shadow: -600px 0px 0 <?php echo $categoria['cor_icone']; ?> inset !important;-moz-box-shadow: -600px 0px 0 <?php echo $categoria['cor_icone']; ?> inset !important;box-shadow: -600px 0px 0 <?php echo $categoria['cor_icone']; ?> inset !important;}
  .member-align-center:hover h1 {-webkit-box-shadow: -600px 0px 0 <?php echo $categoria['cor_icone']; ?> inset !important;-moz-box-shadow: -600px 0px 0 <?php echo $categoria['cor_icone']; ?> inset !important;box-shadow: -600px 0px 0 <?php echo $categoria['cor_icone']; ?> inset !important;}
        ...
        transition-duration: 0.5s;min-height: 300px;box-shadow: 0 0 1px #ccc;box-shadow: 0px 0 0 #fff inset;">
            ...
            <center> <div style="min-height: 130px;"><div class="badge" style="position: absolute; top: 0;left: 50%;padding: 4px 8px;background-color:<?php echo $i['cor_tg_ft'];?>;color: <?php echo $i['cor_txt_tg_ft'];?>;border-radius: 0 0 5px 5px;font-size: 11px;-webkit-transform: translateX(-50%);transform: translateX(-50%);<?php if ($i['featured'] === 'margin-top: 25%'){}else{echo "display: none"; }?>"><?php echo $i['tg_txt']; ?></div><br><br>
                ...
                <div class="member-photo" style=" width: 100%;">                    
                     <h1 class="member-name" id="dife" style=" color: <?php if ($i['featured'] === 'margin-top: 25%'){ echo $i['cor_txt_ft'];}else{echo $categoria['cor_titulo']; }?>; font-size: 220%;letter-spacing: 1px ;position: relative;z-index: 1;top:135px;width: 100%;padding-bottom: 2.5px;padding-top: 2.5px;background-color: <?php if ($i['featured'] === 'margin-top: 25%'){ echo $i['cor_bg_ft'];}else{echo $categoria['cor_botao']; }?>;-webkit-box-shadow: 0 2px 7px 0px rgba(0, 0, 0, 0.1);-webkit-transition-duration: 0.5s;-webkit-transition-timing-function: linear;-moz-box-shadow: 0 2px 7px 0px rgba(0, 0, 0, 0.1);-moz-transition-duration: 0.5s;-moz-transition-timing-function: linear;transition-timing-function: linear;transition-duration: 0.5s;box-shadow: 0 0 1px #ccc;box-shadow: 0px 0 0 #fff inset;"><?php echo $i['titulo']; ?></h1>
                     <img style=" border-radius: 100%;width: 150px;height: 150px;" src="<?php echo ConfigPainel('base_url'); ?>/wa/tabela_de_precos/uploads/<?php echo $i['imagem_arquivo']; ?> ">           
            ...
            <div  class="member-info" style="background-color: transparent; min-height: 100px; height: auto;">
              <?php foreach($social as $s => $valor): ?> 
                <ul target="_blank" href="" class="member-icon" style="text-decoration: none; position: relative; color: <?php if ($i['featured'] === 'margin-top: 25%'){echo $i['cor_txt_ft']; }else{echo $categoria['cor_bg'];}?>; font-size: 12px; padding: 0; text-align: center; margin-top: 8%;  ">
                     <li class="zxc" style=" <?php if ($s<1) { echo "font-weight: bold; font-size: 15px"; }elseif ($s>0 && $s<2) { echo "font-size: 14px"; }?>; list-style-type: none; display: inline-block; width: 100%; overflow-wrap: break-word; background-color: transparent;"> <?php echo $valor['link'];?> </li> 
