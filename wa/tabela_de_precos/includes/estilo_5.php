...
#v1:hover { animation: tc-shake 0.5s;animation-iteration-count: 0.1s;}
#v2:hover { animation: tc-scale 0.5s;animation-iteration-count: 0.5s;}
#v3:hover { animation: tc-rotate 0.5s;animation-iteration-count: 0.1s;}
#v4:hover { animation: tc-animation-scale-down 0.5s;animation-iteration-count: 0.1s;}
#v5:hover { animation: tc-animation-scale-up 0.5s;animation-iteration-count: 0.1s;}
#v6:hover { animation: tc-fade-right 0.5s;animation-iteration-count: 0.5s;}
#v7:hover { animation: tc-fade-left 0.5s;animation-iteration-count: 0.1s;}
#v8:hover { animation: tc-fade-bottom 0.5s;animation-iteration-count: 0.1s;}
#v9:hover { animation: tc-fade-top 0.5s;animation-iteration-count: 0.1s;}
#v10:hover { animation: tc-fade 0.5s;animation-iteration-count: 0.1s;}

#v11:hover { animation: tc-shake 0.5s;animation-iteration-count: 0.1s;}
#v12:hover { animation: tc-scale 0.5s;animation-iteration-count: 0.1s;}
#v13:hover { animation: tc-rotate 0.5s;animation-iteration-count: 0.1s;}
#v14:hover { animation: tc-animation-scale-down 0.5s;animation-iteration-count: 0.1s;}
#v15:hover { animation: tc-tc-animation-scale-up 0.5s;animation-iteration-count: 0.1s;}
#v16:hover { animation: tc-tc-fade-right 0.5s;animation-iteration-count: 0.1s;}
#v17:hover { animation: tc-tc-fade-left 0.5s;animation-iteration-count: 0.1s;}
#v18:hover { animation: tc-fade-bottom 0.5s;animation-iteration-count: 0.1s;}
#v19:hover { animation: tc-fade-top 0.5s;animation-iteration-count: 0.1s;}
#v20:hover { animation: tc-fade 0.5s;animation-iteration-count: 0.1s;}

#v21:hover { animation: tc-shake 0.5s;animation-iteration-count: 0.1s;}
#v22:hover { animation: tc-scale 0.5s;animation-iteration-count: 0.1s;}
#v23:hover { animation: tc-rotate 0.5s;animation-iteration-count: 0.1s;}
#v24:hover { animation: tc-animation-scale-down 0.5s;animation-iteration-count: 0.1s;}
#v25:hover { animation: tc-tc-animation-scale-up 0.5s;animation-iteration-count: 0.1s;}
#v26:hover { animation: tc-tc-fade-right 0.5s;animation-iteration-count: 0.1s;}
#v27:hover { animation: tc-tc-fade-left 0.5s;animation-iteration-count: 0.1s;}
#v28:hover { animation: tc-fade-bottom 0.5s;animation-iteration-count: 0.1s;}
#v29:hover { animation: tc-fade-top 0.5s;animation-iteration-count: 0.1s;}
#v30:hover { animation: tc-fade 0.5s;animation-iteration-count: 0.1s;}
</style>
        ...
        <div class="member-align-center b1 <?php echo $categoria['efeito_hover']; ?> " id="v<?php echo $i['id']?>"  style="background-color: <?php if ($i['featured'] === 'margin-top: 25%'){ echo $i['cor_bg_ft'];}else{echo $categoria['cor_botao']; }?>;margin-bottom: 33px;-webkit-box-shadow: 0 2px 7px 0px rgba(0, 0, 0, 0.1);box-shadow: 0 2px 7px 0px rgba(0, 0, 0, 0.1);min-height: 300px;">
            ...
            <div  class="member-info" style="background-color: transparent; min-height: 100px; height: auto;">
              <?php foreach($social as $s): ?> 
                <ul target="_blank" href="" class="member-icon" style="text-decoration: none; position: relative;  color: <?php if ($i['featured'] === 'margin-top: 25%'){echo $i['cor_txt_ft']; }else{echo $categoria['cor_bg'];}?>; font-size: 12px; padding: 0; text-align: center; margin-top: 8%;  "><li id="zxc" style=" position: relative; display: inline-block; white-space: nowrap;"  class="<?php echo $s['icon_social']; ?>"></li>
